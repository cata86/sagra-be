...
public class TavoloAccomodato   {
  ...
  public TavoloAccomodato id(Long id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public TavoloAccomodato idSerata(Long idSerata) {
  ...
  **/
  ...
  public TavoloAccomodato idTavoloReale(Long idTavoloReale) {
  ...
  **/
  ...
  public TavoloAccomodato stato(StatoEnum stato) {
    this.stato = stato;
    return this;
  }
  ...
  **/
  ...
  public TavoloAccomodato accomodatoOrario(DateTime accomodatoOrario) {
  ...
  **/
  ...
  public TavoloAccomodato inOrdinazioneOrario(DateTime inOrdinazioneOrario) {
  ...
  **/
  ...
  public TavoloAccomodato ordinazioneOrario(DateTime ordinazioneOrario) {
  ...
  **/
  ...
  public TavoloAccomodato liberatoOrario(DateTime liberatoOrario) {
