...
public class PietanzaOrdinata   {
  @JsonProperty("id")
  private Long id = null;

  @JsonProperty("pietanza")
  private PietanzaOrdinataPietanza pietanza = null;
  ...
  public PietanzaOrdinata id(Long id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public PietanzaOrdinata pietanza(PietanzaOrdinataPietanza pietanza) {
  ...
  **/
  ...
  public PietanzaOrdinataPietanza getPietanza() {
    return pietanza;
  }

  public void setPietanza(PietanzaOrdinataPietanza pietanza) {
    this.pietanza = pietanza;
  }
  ...
  **/
  ...
  public PietanzaOrdinata numSequenza(Integer numSequenza) {
