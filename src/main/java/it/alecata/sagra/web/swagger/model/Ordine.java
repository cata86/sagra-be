...
public class Ordine   {
  ...
  **/
  ...
  public Ordine idTavoloAccomodato(Long idTavoloAccomodato) {
  ...
  **/
  ...
  public Ordine data(Integer data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public Ordine pietanzeOrdinate(List<OrdinilistaOrdiniByTavoloIdPietanzeOrdinate> pietanzeOrdinate) {
    this.pietanzeOrdinate = pietanzeOrdinate;
    return this;
  }

  public Ordine addPietanzeOrdinateItem(OrdinilistaOrdiniByTavoloIdPietanzeOrdinate pietanzeOrdinateItem) {
  ...
  **/
  ...
  public Ordine numCoperti(Integer numCoperti) {
